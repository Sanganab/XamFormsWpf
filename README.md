...
<p><b><span style="font-family:verdana,sans-serif">There are many IoC containers that are available for use with Xamarin projects, but for the purpose of this demo, I decided to create a quick one myself.&nbsp; This will replace Xamarin.Forms DependencyService class, which isn't available in WPF, and will wire up our IHelloService interface with an implementation in our Forms and WPF projects later.</span></b></p>
<div>
